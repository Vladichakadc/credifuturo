...
// Columnas optimizadas para vista del socio: omitimos su propio nombre/cédula/customer_id, item_quantity, mes/año abonado duplicados.
// Se añaden columnas calculadas: Periodo (badge), Δ vs anterior, Acumulado.
const SAVINGS_COLS = [
    { key: 'externalId', label: 'Id_VM', minW: 90 },
...
// Enriquece registros con delta vs anterior cronológico y acumulado neto. Útil para los renderers.
...
// Renderer especializado para celdas de la tabla Capital Ahorrado
        ...
        <>
            <div className="flex items-center justify-between mb-4 shrink-0">
                <div>
                    ...
                    <p className="text-xs text-gray-400 mt-0.5">Mostrando los primeros {Math.min(25, data.length)} de {data.length} aporte(s)</p>
                </div>
