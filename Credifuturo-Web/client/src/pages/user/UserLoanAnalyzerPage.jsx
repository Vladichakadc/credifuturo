...
const UserLoanAnalyzerPage = () => {
    ...
    const v = calcVerdict(analysis, { audience: 'user' });
    ...
    return (
        <div className="space-y-6">
            {/* Page header */}
            <div>
                {/* El título y la explicación de la regla 3× ya están en el
                    encabezado del layout (utils/paginasInfo.js). */}
            </div>
                ...
                <div className="p-5 space-y-5">
                    ...
                    {analysis && v && !loadingAnalysis && (
                        <div className="space-y-4">
                                    ...
                                    <div className="flex items-start justify-between gap-4 mb-3">
                                        <div className="flex items-center gap-2.5">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm font-bold text-gray-800">Tu salud financiera consolidada</p>
                                            </div>
                                        </div>
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        {analysis.tieneCompromisoNoRetiroAhorros && (
                                            <p className="text-xs font-semibold text-amber-900 mt-1.5 bg-amber-100 inline-block px-2 py-0.5 rounded">
                                                ⚠ Aplica a tu caso: tienes un préstamo que cruza el 31-dic-{analysis.yearActual}
                                            </p>
                                        )}
                                    </div>
                                </div>
                            ...
                            {/* Payment history */}
                            <div>
                                <p className="text-xs font-bold text-gray-700 uppercase tracking-wider mb-2">Historial Completo de Cuotas</p>
                                <div className="grid grid-cols-4 gap-2 text-center">
                                    <div className="bg-emerald-50 rounded-xl py-2.5 border border-emerald-100">
                                        ...
                                        <p className="text-xs text-emerald-700 font-semibold uppercase tracking-wide mt-0.5">Pagadas</p>
                                    </div>
                                    <div className={`rounded-xl py-2.5 border ${analysis.totalCuotasMoraEP > 0 ? 'bg-red-50 border-red-200' : 'bg-gray-50 border-gray-100'}`}>
                                        ...
                                        <p className={`text-xs font-semibold uppercase tracking-wide mt-0.5 ${analysis.totalCuotasMoraEP > 0 ? 'text-red-500' : 'text-gray-600'}`}>
                                            Mora EP Activa
                                        </p>
                                        {analysis.totalCuotasMoraEP > 0 && (
                                            <p className="text-[11px] text-red-400">${(analysis.totalMoraEPValor || 0).toLocaleString('es-CO')}</p>
                                        )}
                                    </div>
                                    <div className={`rounded-xl py-2.5 border ${analysis.historialMoraTotal > 0 ? 'bg-orange-50 border-orange-100' : 'bg-gray-50 border-gray-100'}`}>
                                        ...
                                        <p className={`text-xs font-semibold uppercase tracking-wide mt-0.5 ${analysis.historialMoraTotal > 0 ? 'text-orange-400' : 'text-gray-600'}`}>
                                            Mora Histórica
                                        </p>
                                    </div>
                                    <div className={`rounded-xl py-2.5 border ${analysis.historialPendTotal > 0 ? 'bg-amber-50 border-amber-100' : 'bg-gray-50 border-gray-100'}`}>
                                        ...
                                        <p className={`text-xs font-semibold uppercase tracking-wide mt-0.5 ${analysis.historialPendTotal > 0 ? 'text-amber-500' : 'text-gray-600'}`}>
                                            Por Vencer
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="mt-6 mb-6">
                                    ...
                                    {analysis.prestamosVigentes?.length > 0 ? (
                                                                    ...
                                                                    {loan.fechaUltimaCuota ? (
                                                                        <div className="inline-flex flex-col items-center">
                                                                            ...
                                                                            {loan.aplicaCompromisoNoRetiro && (
                                                                                <span className="text-[11px] mt-0.5 px-1.5 py-0.5 rounded bg-amber-100 text-amber-800 font-bold inline-flex items-center gap-0.5">
                                        ...
                                        <div className="bg-gray-50 border border-gray-100 rounded-xl p-4 text-center mt-2">
                                            <p className="text-sm font-medium text-gray-700">No hay préstamos con cuotas pendientes en este momento.</p>
                                        </div>
                                    )}
                                </div>
                            </div>
