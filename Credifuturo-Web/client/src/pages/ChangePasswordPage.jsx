            ...
            <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-8">
                ...
                {user?.mustChangePassword && (
                    <div className="mb-5 bg-amber-50 border border-amber-200 rounded-lg p-3 flex gap-2 text-sm text-amber-800">
                        ...
                        <span>
                            Es tu primer ingreso. Ingresa la contraseña genérica <strong>Coop2025</strong> en el campo "Contraseña actual" y establece una contraseña personal para continuar.
                        </span>
                    </div>
                )}
