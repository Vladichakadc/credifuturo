...
class GlobalErrorBoundary extends React.Component {
    ...
    componentDidCatch(error, errorInfo) { fetch('/api/log-crash', { method: 'POST', body: JSON.stringify({ error: error.message, stack: errorInfo.componentStack }), headers: { 'Content-Type': 'application/json' } }).catch(() => {});
